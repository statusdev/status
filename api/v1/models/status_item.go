...
// StatusItem SubscriberDetails describes a new subscriber who wants to get updates from the instance
...
func (m *StatusItem) validateID(formats strfmt.Registry) error {
